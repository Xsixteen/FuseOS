all:
	...
	i686-elf-gcc -T linker.ld -o ./images/fuseOS.bin -ffreestanding -O2 -nostdlib ./bootloader/bootloader.o ./kernel/main.o ./kernel/interrupt.o ./kernel/asm/irqhandlers.o
